...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-$a)ba+_q43%vfhb6j*bdf=ape+br7_^@26$)3(%b)d$l$6%yte')
...
INSTALLED_APPS = [
    ...
    'core',  # Our athlete management app
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='TAILWIND Coaching <mehul@mehulved.com>')
